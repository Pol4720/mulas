...
\begin{frame}
\frametitle{Algoritmos Greedy - Estrategias Locales}

\textbf{Característica:} Decisiones locales sin reconsideración, \highlight{extremadamente rápidos}

\vspace{0.3cm}
\textbf{First Fit Decreasing (FFD) - Minimalista:}
\begin{itemize}
    \item Ordenar ítems por peso (descendente)
    \item Asignar al primer contenedor que quepa
\end{itemize}

\vspace{0.2cm}
\textbf{Best Fit Decreasing (BFD) - Equilibrado:}
\begin{itemize}
    \item Ordenar ítems por valor (descendente)
    \item Asignar al contenedor que minimiza diferencia resultante
\end{itemize}

\vspace{0.2cm}
\textbf{Round Robin / LPT Balanced:}
\begin{itemize}
    \item Ordenar ítems por valor (descendente)
    \item Asignar siempre al contenedor con menor carga actual
\end{itemize}

\vspace{0.3cm}
\textbf{Complejidad:} $O(n \log n + n \cdot k)$ para todos

\vspace{0.2cm}
\textbf{Trade-off:} \highlight{Velocidad} (milisegundos) vs \highlight{Optimalidad} (3-15\% gap)
...
\vspace{0.3cm}
\highlight{3. Herramientas:} 11 algoritmos, dashboard interactivo, benchmarking
