...
\author{R. A. Matos Arderí \\ A. Ponce González \\ A. Romero Imbert}
...
\begin{itemize}
    \item 5 paquetes: 2kg, 3kg, 4kg, 1kg, 2kg
    \item 2 camiones: 6kg cada uno
...
\begin{quote}
Existe asignación factible con desbalance $\leq B$?
\end{quote}
...
\vspace{0.5cm}
\highlight{Resultado:} El problema es \textbf{NP-Completo}
...
\Large
\vspace{1cm}
PARTITION $\rightarrow$ 3-PARTITION $\rightarrow$ BALANCED-BIN-PACKING
