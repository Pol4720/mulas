...
\begin{itemize}
    ...
    \item Establecemos capacidad $C_j = B$ para todo $j \in \{1, \ldots, k\}$ (capacidades uniformes)
\end{itemize}

\textbf{Nota:} La reducción utiliza capacidades uniformes, pero el problema con capacidades heterogéneas es al menos tan difícil, ya que generaliza el caso uniforme.
